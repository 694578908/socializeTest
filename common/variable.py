...
def variable_code(redis_data):
    ...
    if code is None:
        ...
        error_message = "\033[1m\033[31m" + f"{'get_mobile_code_key:1' + key}未获取到验证码，请检查conftest.py手机号或test_case.yml账号密码是否正确" + "\033[0m"
